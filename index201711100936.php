        ...
        <section id="container" class="">
            <header class="header dark-bg">
                ...
                <?php
                    ...
                    $menu_array = $mysql->select('id,groupid,name','xedaojia_menu');
                    //print_r($menu_array);
                ?>
                    ...
                    <ul class="nav pull-right top-menu">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu extended logout">
                                ...
                                <li class="eborder-top"><a href="password.php"><i class="icon_profile"></i>修改密码</a></li>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'GET' and $_GET['id']){
                if (isset($_SESSION[id])) {
                    $where = 'id='.$userGroupid[0]['menugid'];
